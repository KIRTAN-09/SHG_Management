...
<script>
    ...
    function displayMemberDetails(memberId) {
        ...
        reportContainer.innerHTML = `
            ...
            <p><strong>Share Price:</strong> INR.${member.share_price}</p>
            <p><strong>Member Type:</strong> ${member.type}</p>
            <p><strong>Status:</strong> ${member.status}</p>

            <h2>Member Savings</h2>
            <p><strong>Total Savings:</strong> INR.${member.total_savings}</p>
            <p><strong>Last Deposit Date:</strong> ${member.last_deposit_date}</p>
            <p><strong>Last Deposit Amount:</strong>INR.${member.last_deposit_amount}</p>
