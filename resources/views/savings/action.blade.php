...
<div class="flex justify-center space-x-2">
    ...
    <form action="{{ route('savings.destroy', $id) }}" method="POST" style="display:inline;" onsubmit="return showDeletePopup(event, this)">
        @csrf
        @method('DELETE')
...
<div id="deletePopup" class="popup-box" style="display: none;">
    <h3>Are you sure you want to delete this saving?</h3>
